...
<head>
    ...
    <style>
        ...
        body{
            ...
            max-width: 100%;
            /*splash.jpg*/
            background-image: url("{{asset('image/web/duf5.jpg') }}");
...
<div class="airdrop">
    ...
    <div class="air-content">
        <div class="c-tab airdrop-form">
            ...
            <div class="form-item">
                <div class="number-box">
                    <div class="form-item-title">所得金币： </div>
                    <input type="number" id="airdrop-gold" name="gold" class='gold' value="0" placeholder="所得金币" readonly>
                    <img class="" src="{{ asset('image/web/gold.png') }}" alt="">
                </div>
            </div>
